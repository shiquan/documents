...
\begin{tikzpicture}
  ...
  \begin{scope}[xshift=0cm, yshift=-7cm]
    \fill[white,fill opacity=0.9] (0,0) rectangle (5,5);
    \draw[black, dashed, ultra thick] (0,0) rectangle (5,5);
    \node[anchor=south]  at (2.5,0) {\includegraphics[width=5cm]{rmdup64.png}};
    \node[align=center, fill=colorn, drop shadow, ultra thick, text width=5cm, draw = black, text=white] (rmd) at (2.5,5.5) {\bfseries{Remove duplications}};
  \end{scope}
  ...
  \begin{scope}[xshift=6cm, yshift=-7cm]
    \fill[white,fill opacity=.9] (0,0) rectangle (5,5);
    \draw[black, dashed, ultra thick] (0,0) rectangle (5,5);
    \node[anchor=south]  at (2.5,0) {\includegraphics[width=5cm]{cov64.png}};
    \node[align=center, fill=colorn, drop shadow, ultra thick, text width=5cm, draw = black, text=white] (cov) at (2.5,5.5) {\bfseries{Coverage report}};
  \end{scope}
  ...
  \path[->, ultra thick, draw=colora] (alig) edge [out=0,in=180](rmd);
  \path[->, ultra thick, draw=colora] (rmd) edge [in=90] (call);
  \path[->, ultra thick, draw=colora] (rmd) edge [out=45,in=90](cov);
